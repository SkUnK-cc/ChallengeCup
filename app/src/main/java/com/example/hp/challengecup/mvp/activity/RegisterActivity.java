...
public class RegisterActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void initView() {
        ...
        spannableString.setSpan(new ForegroundColorSpan(getResources().getColor(R.color.cyan)),7,spannableString.length(), Spanned.SPAN_INCLUSIVE_INCLUSIVE);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.bt_register_next:
                ...
                startActivityForResult(intent,REQUEST_CODE_REGISTER_TWO);
                break;
