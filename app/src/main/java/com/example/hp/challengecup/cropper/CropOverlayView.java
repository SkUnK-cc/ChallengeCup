package com.example.hp.challengecup.cropper;
...
//        Log.e("stk", "resetPoints, bitmap=" + bitmap);
    ...
    public void crop(CropListener cropListener, boolean needStretch) {
        ...
        // 2. draw original bitmap  截取裁剪区域（不规则）
