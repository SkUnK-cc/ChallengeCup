...
public class CustomHomeScrollView extends ScrollView {
    public static final String TAG = "CustomHomeScrollView";
    ...
    public CustomHomeScrollView(Context context) {
        super(context);
    }

    public CustomHomeScrollView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public CustomHomeScrollView(Context context, AttributeSet attrs, int defStyleAttr) {
